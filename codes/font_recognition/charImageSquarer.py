...
fonts_path = r"E:\Python_Projeler\ComputerVisionProjects\FinalProject\codes\font_recognition\fonts"           #first tests with aerial
saves_path = r"E:\Python_Projeler\ComputerVisionProjects\FinalProject\codes\font_recognition\letters_square"
...
for font in os.listdir(fonts_path):
    ...
    save_path = os.path.join(saves_path,font)
