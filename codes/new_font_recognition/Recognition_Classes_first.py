...
class FontBitMaps:
    def __init__(self, images_path, StarterBit):

        extraction = Extractor(images_path)
        squarer = Squarer(extraction.characterImages)

        self.characterImages = squarer.characterSquares
        self.bit = StarterBit
        self.CreateBitMaps()
    ...
    def CreateBitMaps(self):
        ...
        for img,coordinates in self.characterImages:
            ...
            bit_maps.append([bitmap,coordinates])
